...
exports.classifySheet = classifySheet;
/**
 ...
 */
function classifySheet(summary, header) {
    ...
    if (denseSampleRows.length === 0 && hasVeryLongText)
        return 'cover_or_legal';
    if (denseSampleRows.length === 0 && summary.rowCount <= 5)
        return 'empty';
...
//# sourceMappingURL=sheetClassifier.js.map